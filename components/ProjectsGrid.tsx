...
export default function ProjectsGrid() {
  ...
  const featured = projects.filter((p) => p.shots.length > 0)
  const compact = projects.filter((p) => p.shots.length === 0)
  ...
  return (
    <section id="proyectos" className="shell py-24 md:py-36">
          ...
          <Reveal as="article" key={project.id} className="group">
            ...
            >
              ...
              <div className="lg:col-span-7">
                <ProjectShots
                  shots={project.shots}
                  mobileShots={project.mobileShots}
                  name={project.name}
                  priority={i === 0}
                />
              </div>
      ...
      {/* Compactos */}
      <div className="mt-24 grid border-t border-l border-acero md:grid-cols-2 lg:grid-cols-3">
